...
// const Header = ({menuItems, cartItems, addToCart }) => {
const Header = () => {
  return (
    ...
    <Container>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ms-auto">
          ...
          {/* <Nav.Link href="/OrderNew" onClick={()=> setShow(true)}>Place Order</Nav.Link> */}
          <Nav.Link href="/OrderNew">Place Order</Nav.Link>
          <Nav.Link href="/Contact">Contact</Nav.Link>
          {/* <Nav.Link href="/Cart"  className='cart-link' onClick={() => setShow(false)}> */}
          <Nav.Link href="/Cart"  className='cart-link'>
            Cart
            <BsFillCartCheckFill className='h4' />
            {/* <span>{size}</span>  */}
          </Nav.Link>
